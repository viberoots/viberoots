...
# ------------------------------------
# This file is intentionally minimal. It exists so that `tools/nix/lang-templates.nix`
# can expose a Node symbol bag for discovery. The authoritative Node planner logic
# lives in `tools/nix/planner/node.nix`, and Node builds are driven by Buck macros
