...
let
  ...
  isExcludedPath = rel:
    ...
    (goOnly && lib.hasPrefix "tools/nix/templates" rel) ||
    (goOnly && lib.hasPrefix "tools/scaffolding/templates" rel) ||
    (excludeCppReqs && (rel == "cpp/defs.bzl" || rel == "cpp/wasm_defs.bzl")) ||
    (excludeCppReqs && rel == "tools/nix/templates/cpp.nix");
  allowByRoots = rel:
    rel == "flake.nix" ||
    rel == "flake.lock" ||
