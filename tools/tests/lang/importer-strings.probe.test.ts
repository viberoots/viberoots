...
const cases: Case[] = [
  { target: "//tools/tests/lang/importer_strings:dot", importer: "." },
  { target: "//tools/tests/lang/importer_strings:apps_web", importer: "apps/web" },
  { target: "//tools/tests/lang/importer_strings:libs_some_tool", importer: "libs/some_tool" },
  {
    target: "//tools/tests/lang/importer_strings:repeated_slashes_trailing",
    importer: "apps//web/",
  },
];
