...
// Run all scaffolding scenarios as subtests in parallel with a cap of 10
test("scaffolding e2e (parallel)", { concurrency: 10 }, async (t) => {
  await t.test("new overwrite guard requires --yes or supports --dry-run", async () => {
  ...
  await t.test("regen staging restores original on failure", async () => {
  ...
  await t.test("move, update, delete and ls reflects state", async () => {
  ...
  await t.test("move requires confirmation unless --yes", async () => {
  ...
  await t.test("meta: validate all passes", async () => {
  ...
  await t.test("meta: missing help fails", async () => {
  ...
  await t.test("meta: empty usage fails", async () => {
