...
/**
 * Generate lang/nix_attr_aliases.bzl from tools/lib/nix-attr-aliases.json
...
function renderBzl(map: Record<string, string>): string {
  ...
  return [
    ...
    "# Rendered from tools/lib/nix-attr-aliases.json",
...
async function main() {
  const jsonPath = "tools/lib/nix-attr-aliases.json";
