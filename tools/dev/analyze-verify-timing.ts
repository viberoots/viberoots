...
async function main(): Promise<number> {
  ...
  if (!log) {
    console.error("usage: node tools/dev/analyze-verify-timing.ts --log <path/to/verify.log>");
    console.error("  or: node tools/dev/analyze-verify-timing.ts <path/to/verify.log>");
    return 2;
  }
