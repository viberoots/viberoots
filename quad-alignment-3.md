...
- Docs (in this PR):
  - Update build-system-design.md (patching workflow) to note per‑language workspace prefixes and APFS CoW attempt on macOS.
...
- Docs (in this PR):
  - Update build-system-design.md (patching UX) to mention the global echo toggle and the standard snippet text.
