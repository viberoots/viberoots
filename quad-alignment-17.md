...
- Update the tooling docs (handbook or `build-system-design.md` appendix section) to state:
...
- Add or extend a shared documentation section (handbook or `build-system-design.md`) describing:
