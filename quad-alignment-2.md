...
- Tests & Docs (as part of this PR):
  ...
  - Update `build-system-design.md` to note registry‑first C++ construction.
...
- Tests & Docs (as part of this PR):
  ...
  - Document the split in `build-system-design.md` (exporter/glue section).
...
- Tests & Docs (as part of this PR):
  ...
  - Document the mapping table in `build-system-design.md` (planner section).
