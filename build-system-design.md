...
- Provider-package nodes (`//third_party/providers:*`) are intentionally excluded from `MODULE_PROVIDERS` keys to avoid self-mappings and reduce noise during diagnostics.
