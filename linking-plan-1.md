...
- Wasm linking (`wasm-linking.md`)
- Python extension modules (`python-extension-design.md`)
...
- Update `build-system-design.md` (or a small handbook page if preferred) to state:
...
- Update `linking-roadmap.md` and/or `cpp-linking.md` / `wasm-linking.md` to reference:
...
- Update `build-system-design.md` (or a linking section) to list the new exported fields as part of the planner contract.
