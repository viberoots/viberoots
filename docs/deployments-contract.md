...
- Protected/shared service-client loopback HTTP is a local-fixture transport only and requires an explicit reviewed marker such as `BNX_DEPLOY_LOCAL_FIXTURE_SERVICE=1`; manifest and flag resolution must not grant implicit localhost exceptions.
