...
- Update `docs/cloud-control-design.md` with the executable hook dispatch contract.
...
- Update `docs/control-plane-containerization.md` with build identity vs registry digest semantics.
