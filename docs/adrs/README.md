...
| [00002](00002-deployment-target-strategy.md)        | Deployment Target Strategy        | Accepted                               | Deployment target model and supported provider-family boundaries.                                  |
...
| [00006](00006-secrets-management-strategy.md)       | Secrets Management Strategy       | Accepted with current-doc status notes | Secret/config/runtime URI contract, Vault/Infisical behavior, bootstrap boundaries.                |
