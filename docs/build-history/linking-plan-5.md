...
- Update `build-tools/docs/python-extension-design.md` and `build-tools/docs/python-wasm-design.md` with the supported producers and closure rules
...
- Update `build-tools/docs/python-extension-design.md` with the pinned WASI config source for `EXT_SUFFIX`
...
- Update `build-tools/docs/python-extension-design.md` to clarify that tests must execute, not just build
