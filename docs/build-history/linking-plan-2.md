...
This document is a development plan to implement **Phase 1** from `linking-roadmap.md`.
...
- The documentation describes the header-only target contract in one place (`cpp-linking.md`).
