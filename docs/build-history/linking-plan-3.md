...
Note: Python native extension scaffolding belongs to **Phase 3** and should be tracked in the Phase 3 plan alongside the implementation in `build-tools/docs/python-extension-design.md`.
