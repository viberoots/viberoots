...
[docs/nixos-shared-host-setup.md:113](../../nixos-shared-host-setup.md).)
...
- Repo rename PRs (PR-1..PR-6 in [docs/history/migrations/repo-rename.md](../../history/migrations/repo-rename.md)) are merged on `main`.
...
- Optional service modules from [docs/nixos-shared-host-setup.md:244](../../nixos-shared-host-setup.md) (local Postgres, local Vault, nginx vhost wiring) if they reference the repo path.
...
- `/etc/deployment-host/reviewed-source-ssh.env` (sourced before service start in [docs/nixos-shared-host-setup.md:604](../../nixos-shared-host-setup.md))
...
[docs/nixos-shared-host-setup.md:599](../../nixos-shared-host-setup.md) is now
...
Run on your workstation (not on `mini`) from the repository root.
...
(see [docs/nixos-shared-host-setup.md:682](../../nixos-shared-host-setup.md)).
...
- `localManagedPaths`: a path under the repository root
...
runtime contract is
[docs/control-plane-nixos-container-module.md](../../control-plane-nixos-container-module.md)
and the broader design is
[docs/history/designs/control-plane-containerization.md](../../history/designs/control-plane-containerization.md).
