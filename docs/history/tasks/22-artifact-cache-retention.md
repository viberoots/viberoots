...
`docs/history/designs/deployments-design.md`, and the per-run eligibility check already exists in
...
store. The `docs/history/designs/deployments-design.md` is explicit that upstream caches are not the retention
