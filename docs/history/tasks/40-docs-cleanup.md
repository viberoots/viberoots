...
1. **Identify and archive or delete stale documents.** The following categories are candidates:
   - `docs/history/build-system/logs/` — 78 files of alignment notes (`quad-alignment-1.md` through
   ...
   - `docs/history/designs/legacy/` — 50+ files of similar session-note and completion-checkpoint
...
4. **Add or update a `docs/history/tasks/README.md` index.** The 35 existing task files have no index.
...
6. **Verify cross-references are not broken by any deletions.** `README.md` currently references
   ...
   `docs/handbook/adding-language.md`, `build-tools/docs/cpp/overlays.md`, `docs/handbook/ci.md`,
...
- `docs/history/designs/deployments-design.md`, `docs/deployments-contract.md`, `docs/deployments-schema.md`,
...
- `docs/history/plans/control-plane-plan.md`, `docs/history/designs/cloud-control-design.md`, `docs/history/designs/control-plane-containerization.md`,
...
- `docs/history/designs/infisical-design.md`, `docs/history/plans/infisical-plan.md`, `docs/infisical-bootstrap.md` — the
  secrets cluster
- `docs/sprinkleref.md`, `docs/sprinkleref-check.md` — the sprinkleref reference tooling
- `docs/deployment-control-plane-observability.md`, `docs/history/designs/deployment-adjustment.md`,
  `docs/history/designs/deployment-family-composition.md`, `docs/history/plans/deployments-implementation-plan.md`,
  `docs/history/plans/deployment-plan.md`, `docs/deployment-secrets-api.md`, `docs/history/migrations/deployment-verify-scope.md`,
  `docs/history/plans/external-deployments-plan.md` — the deployment operations cluster
...
referencing documents. The deployment plan (`docs/history/plans/deployment-plan.md`) in particular links to a
large number of peer documents using absolute paths that will break silently if the target is
removed.

**Misjudging what is "historical."** `docs/history/designs/legacy/quad-alignment-42.md` through
...
`docs/adrs/README.md`, `docs/history/tasks/README.md`) must pass the stale-names lint check. Do not use
...
(already specified in task #27), and `docs/history/tasks/README.md` as a lightweight table. Other
...
- Run `rg "docs/build-history|docs/design-history" docs README.md` before archiving any file in
  those directories. Inbound references from active documents prevent deletion.

- The `docs/history/build-system/nix-gaps-baseline.md` file is machine-generated (it records a `node ...` command and a timestamp). Its regeneration command is embedded in the file. If the file is useful for future baseline comparisons, document where to regenerate it. If the migration it tracked is complete and enforced by tests, the file is archivable.
...
- `docs/history/migrations/reorg-phase-0-baseline.md` is a three-section snapshot recording that `i`, `b`, `v` passed at a specific reorg moment. This has no ongoing reference value and is a clear deletion candidate.
