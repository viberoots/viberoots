...
This plan implements `docs/history/build-system/nix-gaps-plan.md` using a list of PRs.
...
- PRs in this document remain aligned to `docs/history/build-system/nix-gaps-plan.md` framing:
...
- PR-2: baseline generator exists at `build-tools/tools/dev/nix-gaps-baseline.ts`, baseline test at
  ...
  `docs/history/build-system/nix-gaps-baseline.md` (`336f513`).
...
- Add `docs/history/build-system/nix-gaps-baseline.md` generated by the script.
...
- Commit the generated `docs/history/build-system/nix-gaps-baseline.md`.
...
I will run and codify cross-language parity and hermeticity checks for earlier migrations.
...
- Update parity and hermeticity notes in `docs/history/build-system/nix-gaps-baseline.md` and related docs.
...
- Update `docs/history/build-system/nix-gaps-plan.md` and `docs/handbook/nix-gaps.md` status sections.
...
- Update phase tracking notes in `docs/history/build-system/nix-gaps-plan.md` if needed.
...
- Update relevant Go migration notes in `docs/history/build-system/nix-gaps-prs.md` and/or
...
- Align coverage policy language across:
  ...
  - `TESTING.md`
  - `docs/history/build-system/nix-gaps-prs.md` guardrails section
...
- Update `docs/history/build-system/nix-gaps-prs.md` to record supersession and final route contract outcome.
...
- PR-21 is explicitly marked as superseded by PR-23 in `docs/history/build-system/nix-gaps-prs.md`.
...
- Update `docs/handbook/getting-started-on-a-pr.md` to reflect strict file-size gate behavior in
  required flows.
- Add a short note in `docs/history/build-system/nix-gaps-prs.md` execution log for this PR documenting closure
  evidence.
...
- Add a short execution-log note in `docs/history/build-system/nix-gaps-prs.md` summarizing matrix evidence and the
