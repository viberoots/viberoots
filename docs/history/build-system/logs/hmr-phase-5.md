...
5. Documentation closure:
   - `docs/history/build-system/logs/hmr-phase-5.md`, `build-tools/docs/build-system-design.md`, and scaffolding/runtime docs describe the same canonical behavior
