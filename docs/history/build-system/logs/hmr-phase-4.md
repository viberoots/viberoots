...
This plan covers implementation of Phase 4 from `docs/history/designs/legacy/hmr-plan.md`: regression coverage and docs lock-in, without reopening Phase 2 design decisions.
...
- Update `docs/history/designs/legacy/hmr-plan.md` and scaffolding docs sections used as canonical contract sources:
...
- Update `docs/history/designs/legacy/hmr-plan.md` Phase 4 closeout notes to reflect completed removal.
...
- Update `docs/history/designs/legacy/hmr-plan.md` and `build-tools/docs/scaffolding.md` to reflect final Phase 4 completeness:
