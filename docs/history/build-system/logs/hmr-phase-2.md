...
This plan covers implementation of Phase 2 from `docs/history/designs/legacy/hmr-plan.md`: wasm dev update pipeline for
...
- Update `docs/history/build-system/logs/hmr-phase-2.md` and template-facing docs to record gap closure outcomes:
