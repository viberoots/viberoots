...
- Update `build-tools/docs/abstractions.md` to mark the internal helpers as implementation details only.
...
- Update `build-tools/docs/abstractions.md` to state that macros must not load or call internal wiring helpers.
...
- Update `build-tools/docs/abstractions.md` to list the new registry as the canonical source.
...
- Update `build-tools/docs/abstractions.md` to point to the lockfile basename registry and the new parity test.
...
- Update `build-tools/docs/abstractions.md` to include a clear section on the policy and why it differs.
...
- Update `build-tools/docs/abstractions.md` with an explicit description of Node and Python patch inclusion policy.
