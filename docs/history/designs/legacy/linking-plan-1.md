...
This document is a development plan to implement **Phase 0** from `docs/history/build-system/linking-roadmap.md`.
...
- native C++ linking (`build-tools/docs/cpp-linking.md`)
- Wasm linking (`build-tools/docs/wasm-linking.md`)
- Python extension modules (`docs/history/designs/legacy/python-extension-design.md`)
