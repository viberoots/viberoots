...
- Update `build-tools/docs/abstractions.md` to list `nix_python_binary` under the `srcsless_rule` wiring path and
...
- Update the diagnostics section in `build-tools/docs/abstractions.md` to mention the new prebuild-guard guidance
