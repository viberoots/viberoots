...
This document is a development plan to implement **Phase 2** from `docs/history/build-system/linking-roadmap.md`.
...
- Update `build-tools/docs/wasm-linking.md`:
...
Note: Python native extension scaffolding belongs to **Phase 3** and should be tracked in the Phase 3 plan alongside the implementation in `docs/history/designs/legacy/python-extension-design.md`.
...
The implementation should follow the model described in `build-tools/docs/wasm-linking.md`:
