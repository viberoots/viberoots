...
- Update `build-tools/docs/abstractions.md` to state `merge_provider_edges(...)` is the canonical public helper and
...
- Update `build-tools/docs/abstractions.md` to state that per-language `kindOf` config is centrally defined in the
...
- Update `build-tools/docs/abstractions.md` to note the shared importer-scoped adapter helper and list Node and
...
- Update `build-tools/docs/abstractions.md` to note the shared importer-scoped provider sync helper and document the
...
- Update `build-tools/docs/abstractions.md` to list only `build-tools/lang/sanitize.bzl:sanitize_name` as the C++ sanitizer entry
  point.
