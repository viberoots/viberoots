...
- [Deployment Contract](../../deployments-contract.md) is the fail-closed normative source for shared operator and implementation guarantees across the deployment model
...
- [Deployment Provider Capabilities](../../deployment-provider-capabilities.md) is the rendered normative doc view of that reviewed registry
...
- [Deployment Implementation Plan](../plans/deployment-plan.md)
...
| `opentofu`              | `stack_identity`<br>`state_backend_identity`     | `stack_identity` identifies the reviewed foundation or migration stack<br>`state_backend_identity` identifies the reviewed state backend boundary | `opentofu:<stack_identity>#state:<state_backend_identity>`                                                                                                         |
...
| `opentofu`              | `provision-only`                                   | single-component only                                                                                                               | not reviewed                                 | `all_at_once`                          | `all_at_once`        | `provision-only`                                                    | none                                                   | none                                          |
...
- [Deployment Provider Capabilities](../../deployment-provider-capabilities.md) is the authoritative reviewed contract for built-in provider support
