...
- Generated glue (not committed)
  - `build-tools/tools/buck/graph.json`, `third_party/providers/TARGETS*.auto`, `third_party/providers/auto_map.bzl` are generated by Node scripts and not committed.
