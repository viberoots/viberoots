...
As described in `docs/cpp/drop-cpp-provider.md`, C++ provider sync is a no-op. There is no C++ provider file to generate and no stamps to maintain. Use label introspection instead:
