...
This document is a development plan to implement **Phase 2** from `build-tools/docs/linking-roadmap.md`.
...
Note: Python native extension scaffolding belongs to **Phase 3** and should be tracked in the Phase 3 plan alongside the implementation in `docs/design-history/python-extension-design.md`.
