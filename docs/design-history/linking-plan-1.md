...
This document is a development plan to implement **Phase 0** from `build-tools/docs/linking-roadmap.md`.
...
- Python extension modules (`docs/design-history/python-extension-design.md`)
