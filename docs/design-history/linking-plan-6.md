...
This document is a development plan to implement Phase 4 from `build-tools/docs/linking-roadmap.md`. I keep the plan as a list of PRs. Each PR includes its own tests and documentation updates. I do not plan any tests-only or docs-only PRs. No functionality should land without tests in the same PR.
