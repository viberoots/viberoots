...
- Update `build-tools/docs/abstractions.md`, `docs/handbook/macro-stamping-cookbook.md`, and `docs/handbook/adding-language.md` to name the unified entrypoint as canonical and mark per-model helpers as internal.
