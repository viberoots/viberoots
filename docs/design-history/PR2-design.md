...
1. Create lockfile with 3 importers: `projects/apps/web`, `projects/apps/api`, `projects/libs/utils`
...
```typescript
const cases = [
  { lf: "projects/apps/web/pnpm-lock.yaml", imp: "projects/apps/web", expectPrefix: "lf_" },
  { lf: "projects/libs/utils/pnpm-lock.yaml", imp: "projects/libs/utils", expectPrefix: "lf_" },
...
#### 6.3 Update `docs/handbook/getting-started-on-a-pr.md`
...
3. `docs/handbook/getting-started-on-a-pr.md` — Add Node commands
...
- Update docs/handbook/getting-started-on-a-pr.md with Node-specific commands
...
Refs: docs/design-history/pnpm-plan.md PR 2 acceptance criteria
```
...
## Acceptance Criteria (from docs/design-history/pnpm-plan.md)
...
3. **Documentation updates merged**
   ...
   - Commands added to `docs/handbook/getting-started-on-a-pr.md`
...
- [docs/design-history/pnpm-plan.md](./pnpm-plan.md) — Original PR plan
...
[
  ...
  {
    "name": "//projects/libs/utils:lib",
    "rule_type": "genrule",
    "labels": [
      "lockfile:projects/libs/utils/pnpm-lock.yaml#projects/libs/utils",
      "lang:node",
      "kind:lib"
    ],
    "srcs": ["src/index.ts"],
