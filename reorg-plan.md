...
This document is a development plan to implement Phases 0-5 of `reorg.md`. I keep the plan as a list of PRs. Each PR includes its own tests and documentation updates. I do not plan any tests-only or docs-only PRs. No functionality should land without tests in the same PR.

## Prerequisites (must already be true)

- The Phase 0-5 scope is approved in `reorg.md`.
