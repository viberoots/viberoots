...
- Strengthen partial‑clone grace and error UX

---

## PR 10: Typed language contracts (TS interfaces)
...
## PR 11: Single source of truth for languages (manifest → codegen)
...
## PR 12: Provider sync framework (shared helpers)
...
## PR 13: Exporter adapter contract
...
## PR 14: Planner plug‑in files per language (Nix)
...
## PR 15: New‑language scaffolding kit
...
## PR 16: Language conformance tests (contract suite)
...
## PR 17: Centralized error & UX policy for partial clones
...
## PR 18: Capability matrix & CI auto‑staging
