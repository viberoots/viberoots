...
- Importer inference parity: for root importer `.` and nested importers like `apps/web`, the inferred importer matches `tools/lib/importers.ts:computeImporterLabel(...)`.
- Invalidation:
