...
[Deployment Design Adjustment](docs/deployment-adjustment.md). The goal is to align the deployment
...
- Existing deployment docs, including `docs/deployment-plan.md`, `docs/deployments-design.md`,
...
- Update `docs/deployments-design.md`, `docs/deployments-contract.md`,
  `docs/deployments-schema.md`, and `docs/deployments-usage.md` to remove branch-backed lane
  requirements.
- Update `docs/deployment-plan.md` where it assumes environment branches are authoritative.
...
- Update operator docs describing `--validate-only`, `--admit-and-deploy`, and protected/shared
  source selection.
- Update `docs/deployment-plan.md` source-admission language to match the adjusted model.
...
- Update `docs/deployments-contract.md` and `docs/deployment-plan.md` to identify control-plane
...
- Update design/contract language that says environment branch state is authoritative for
  promotion.
- Update `docs/deployment-plan.md` promotion sections to match the adjusted model.
...
- Update `docs/deployment-plan.md` replay and rollback sections to match control-plane stage state.
...
- Update `docs/deployment-plan.md` so it is fully aligned with `docs/deployment-adjustment.md` and
  no longer describes branch-backed lanes as a target-state requirement.
- Keep `docs/deployment-adjustment.md` as a concise addendum or fold its stable content into the
...
- `docs/deployment-plan.md` is fully aligned with the adjusted design.
