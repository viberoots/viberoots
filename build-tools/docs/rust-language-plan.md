...
| Rust Pyodide extension parity        | PR-7 assessment  | PR-14    | Repository scope wired    | Pinned PyEmscripten build/import in PR-13; lifecycle, scaffold, remote/cache, reproducibility, and docs are PR-14 repository scope; external gates remain |
