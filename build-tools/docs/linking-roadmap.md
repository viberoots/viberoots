...
- Python extension module support (`docs/design-history/python-extension-design.md`)
...
- `build-tools/docs/cpp-linking.md`, `build-tools/docs/wasm-linking.md`, and `docs/design-history/python-extension-design.md` should be read as:
  - a conceptual model
