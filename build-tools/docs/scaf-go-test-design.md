...
- Files
  - `README.md` and/or `build-tools/docs/scaffolding.md`: add a short “Go tests” section with:
...
- Acceptance criteria
  ...
  - Links or references from `build-tools/docs/scaffolding.md` to the design or `help` are correct.
