...
```python
load("@viberoots//build-tools/node:defs_nix.bzl", "node_webapp")
...
- Macro stamping: Planned — Node macro should call `stamp_labels(lang="node", kind=...)` and append providers from `@workspace_providers//:auto_map.bzl`.
