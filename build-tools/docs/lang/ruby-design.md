...
Provide thin macros consistent with Go/Node style and `build-tools/lang/defs_common.bzl` helpers:
...
7. Rails template
   - Add scaffolding and a sample app under `projects/apps/rails-example` (optional) to validate flow.
