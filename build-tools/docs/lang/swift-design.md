...
- Language macros live under `swift/defs.bzl` and use `@workspace_providers//:auto_map.bzl`.
...
3. Generate auto_map → writes `.viberoots/workspace/providers/auto_map.bzl`.
