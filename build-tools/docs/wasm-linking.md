...
Python extension modules (`build-tools/docs/python-extension-design.md`) are another consumer of the same shared “link closure” primitives, so I want the same attribute names and the same Nix/Starlark helpers reused there as well.
