...
test("scaffold ts go-cpp-lib; build addon + wasm; both return 5", { skip: SKIP_PR8 }, async () => {
  await runInTemp("ts-go-cpp-lib", async (tmp, $) => {
...
`,
    ...
    // Note: no native artifact copied; this e2e focuses on scaffold + wiring
