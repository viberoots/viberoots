...
test("@viberoots//build-tools/lang:defs_common.bzl must not re-export removed mutating helpers", async () => {
  ...
  assert.equal(
    ...
    0,
    [
      "viberoots/build-tools/lang/defs_common.bzl must not export *_legacy_mutating symbols.",
      "Removed mutating helpers must remain out of the public @viberoots//build-tools/lang surface.",
      "",
