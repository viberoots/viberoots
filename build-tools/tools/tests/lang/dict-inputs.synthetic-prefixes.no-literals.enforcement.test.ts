...
test("Starlark does not hardcode dict-safe synthetic prefix literals outside viberoots/build-tools/lang/dict_inputs.bzl", async () => {
  ...
  if (offenders.length > 0) {
    ...
    console.error(
      "expected callers to import PATCH_INPUTS_KEY_PREFIX/PROVIDER_EDGES_KEY_PREFIX/GLOBAL_NIX_INPUTS_KEY_PREFIX via @viberoots//build-tools/lang:defs_common.bzl",
    );
