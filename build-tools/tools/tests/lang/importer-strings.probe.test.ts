...
const cases: Case[] = [
  { target: "viberoots//build-tools/tools/tests/lang/importer_strings:dot", importer: "." },
  {
    target: "viberoots//build-tools/tools/tests/lang/importer_strings:projects_apps_web",
    importer: "projects/apps/web",
  },
  {
    target: "viberoots//build-tools/tools/tests/lang/importer_strings:projects_libs_some_tool",
    importer: "projects/libs/some_tool",
  },
  {
    target: "viberoots//build-tools/tools/tests/lang/importer_strings:repeated_slashes_trailing",
    importer: "projects/apps//web/",
  },
];
