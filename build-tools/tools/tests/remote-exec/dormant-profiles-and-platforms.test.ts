...
const profilesPath = viberootsSourcePath("viberoots/toolchains/remote_execution_profiles.bzl");
const platformsPath = viberootsSourcePath("viberoots/toolchains/remote_execution_platforms.bzl");
