...
test("node go-addon: scaffold, build addon via Buck planner, run and observe Go->Node data", async () => {
  await runInTemp("node-go-addon-runtime-e2e", async (tmp, _$) => {
    ...
    })`node --experimental-strip-types --import ${viberootsTool("viberoots/build-tools/tools/dev/zx-init.mjs")} ${viberootsTool("viberoots/build-tools/tools/buck/export-graph.ts")} --out .viberoots/workspace/buck/graph.json`;
