...
test(
  "generated-authority runtime contract: MODULE_CONTRACTS_DIR is authoritative when set",
  { timeout: TEST_TIMEOUT_MS },
  async () => {
    await runInTemp("webapp-generated-authority-runtime", async (tmp, _$) => {
      ...
      for (const scenario of scenarios) {
        ...
        await fsp.writeFile(payloadAbs, "generated-authority", "utf8");
