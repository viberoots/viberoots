...
test("PR-6 docs contract: active docs use ts command paths for canonical TypeScript templates", async () => {
...
test("PR-6 docs contract: inventory classification is explicit, unique, and scoped", async () => {
