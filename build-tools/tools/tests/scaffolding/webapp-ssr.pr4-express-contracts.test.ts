...
test(
  "PR-4 SSR express contracts: materialize listing, adapter conformance, and Docker startup shape",
  { timeout: TEST_TIMEOUT_MS },
  async () => {
    await withTempRoots(async () => {
      await runInTemp("node-webapp-ssr-pr4-express-contracts", async (tmp, _$) => {
