...
test("PR-1 taxonomy matches templates/ts filesystem roots", async () => {
...
test("PR-1 filesystem contract: no canonical TypeScript templates remain under templates/node", async () => {
