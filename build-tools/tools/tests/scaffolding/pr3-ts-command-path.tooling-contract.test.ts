...
test("PR-3 helper tooling uses ts command path for TypeScript templates", async () => {
...
test("PR-3 manifest discoverability points TypeScript templates to templates/ts", async () => {
