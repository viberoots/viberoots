...
test("PR-7 parity: generated taxonomy adapter is fresh from canonical manifest", async () => {
...
test("PR-7 parity: generated runtime taxonomy data is fresh from canonical manifest", async () => {
  const manifest = await readTemplateManifest();
