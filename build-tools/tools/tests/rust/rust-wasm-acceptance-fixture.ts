...
export async function writeRustWasmFixture(
  ...
  await fs.writeFile(
    ...
    [
      ...
      '#[cfg(feature = "browser")]',
      "#[wasm_bindgen]",
      "pub fn viberoots_observed_behavior() -> i32 { dependency_value() }",
      '#[cfg(not(feature = "browser"))]',
      "#[no_mangle]",
      'pub extern "C" fn viberoots_observed_behavior() -> i32 { dependency_value() }',
      '#[cfg(not(feature = "browser"))]',
      '#[export_name = "viberoots-observed-behavior"]',
      'pub extern "C" fn viberoots_component_observed_behavior() -> i32 { dependency_value() }',
  ...
  await fs.writeFile(
    path.join(root, "wit/probe.wit"),
    [
      "package viberoots:probe;",
      "world calculator {",
      "  export add: func(a: s32, b: s32) -> s32;",
      "  export dependency-answer: func() -> s32;",
      "  export viberoots-observed-behavior: func() -> s32;",
      "}",
      "",
    ].join("\n"),
  );
  ...
  await fs.writeFile(
    ...
    [
      ...
      'rust_wasm_browser_package(name = "browser", crate = "rust_wasm_fixture", behavior_probe = True, srcs = ["src/lib.rs"], features = ["browser"], exported_functions = ["answer", "dependency_answer"], wasm_optimize = "size", visibility = ["PUBLIC"])',
      ...
      'rust_wasm_component(name = "component", crate = "rust_wasm_fixture", behavior_probe = True, srcs = ["src/lib.rs"], wit = "wit/probe.wit", wit_world = "calculator", exported_functions = ["add", "dependency-answer"], wasm_optimize = "size", visibility = ["PUBLIC"])',
      ...
      'rust_wasm_component(name = "component_rebuilt", crate = "rust_wasm_fixture", behavior_probe = True, srcs = ["src/lib.rs"], wit = "wit/probe.wit", wit_world = "calculator", exported_functions = ["add", "dependency-answer"], wasm_optimize = "size")',
