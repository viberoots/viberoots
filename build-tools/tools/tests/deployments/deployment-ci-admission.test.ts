    ...
    ...admissionEvalBase("nixos-shared-host", {
      ...
      evidence: {
        ...
        ciSubmission: {
          ...
          artifactIdentity: "static-webapp:abc123",
          artifactRef: "registry.example.test/pleomino@sha256:abcd",
          idempotencyKey: "jenkins-main-123",
          sbomRefs: ["oci://sbom/pleomino@sha256:beef"],
          signatureRefs: ["sigstore://pleomino/123"],
      ...
      ...admissionEvalBase("nixos-shared-host", {
        ...
        evidence: {
          ciSubmission: {
            ...
            builderIdentity: "jenkins:mini/main",
            artifactIdentity: "static-webapp:abc123",
            artifactRef: "registry.example.test/pleomino:latest",
          },
        },
      }),
    }),
      ...
      ...admissionEvalBase("nixos-shared-host", {
        ...
        evidence: {
          ciSubmission: {
            ...
            builderIdentity: "jenkins:mini/main",
            artifactIdentity: "static-webapp:abc123",
            artifactRef: "/tmp/jenkins/workspace/pleomino/dist",
          },
        },
      }),
    }),
