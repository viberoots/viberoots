RESOURCE_LIMITED_DEPLOYMENT_TESTS = {
    ...
    "build-tools/tools/tests/deployments/cloudflare-pages.infisical-admission-records.test.ts": True,
    "build-tools/tools/tests/deployments/deployment-secret-metadata.cquery.test.ts": True,
    "build-tools/tools/tests/deployments/deployment-secret-runtime-prepare.test.ts": True,
    ...
    "build-tools/tools/tests/deployments/cloudflare-pages.unified-selector-admission.test.ts": True,
    ...
    "build-tools/tools/tests/deployments/sample-deployment-context-explicit-provider.cquery.test.ts": True,
    "build-tools/tools/tests/deployments/sample-deployment-contexts.cquery.test.ts": True,
    "build-tools/tools/tests/deployments/sample-infisical-cutover.cquery.test.ts": True,
    "build-tools/tools/tests/deployments/real-deployment-requirement-profiles.test.ts": True,
    "build-tools/tools/tests/deployments/deployment-admin-infisical.test.ts": True,
    ...
    "build-tools/tools/tests/deployments/deployment-family-metadata.cquery.test.ts": True,
    ...
    "build-tools/tools/tests/deployments/control-plane-container-e2e.test.ts": True,
    "build-tools/tools/tests/deployments/control-plane-host-profile-image-digest.test.ts": True,
    ...
    "build-tools/tools/tests/deployments/control-plane-web-read-model.test.ts": True,
    ...
    "build-tools/tools/tests/deployments/deployment-infisical-worker-fixture.test.ts": True,
    ...
    "build-tools/tools/tests/deployments/kubernetes.replay.retention.test.ts": True,
    ...
    "build-tools/tools/tests/deployments/control-plane-coordination-review.test.ts": True,
    ...
    "build-tools/tools/tests/deployments/provider-artifact-object-provenance.test.ts": True,
    "build-tools/tools/tests/deployments/provider-frozen-kubernetes-worker-execution.test.ts": True,
    "build-tools/tools/tests/deployments/provider-frozen-object-store-authority.test.ts": True,
