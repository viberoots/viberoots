RESOURCE_LIMITED_DEPLOYMENT_TESTS = {
    ...
    "build-tools/tools/tests/deployments/sprinkleref-check-app-target.test.ts": True, "build-tools/tools/tests/deployments/sprinkleref-check-json.test.ts": True, "build-tools/tools/tests/deployments/sprinkleref-check-report.test.ts": True, "build-tools/tools/tests/deployments/sprinkleref-check-target.test.ts": True,
