...
export async function writeTempCloudflareValidationWorkspace(
  ...
  await fsp.writeFile(
    ...
    [
      ...
      '    repository = "example/sandbox",',
      "    branch_protections = [",
      '        {"stage": "staging", "branch": "env/demo/staging", "required_checks": "", "fast_forward_only": "true", "normal_advance_principals": "app:deploy-bot", "emergency_direct_push_principals": "team:sre-break-glass"},',
      "    ],",
      '    visibility = ["PUBLIC"],',
      ")",
      "",
