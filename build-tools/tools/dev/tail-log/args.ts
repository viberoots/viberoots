...
function usage(): string {
  return [
    "usage:",
    "  build-tools/tools/bin/tail-log [-n LINES] [PID]",
    "  build-tools/tools/bin/l        [-n LINES] [PID]",
    "  build-tools/tools/bin/tail-log --status [--json] [PID]",
    "  build-tools/tools/bin/l        --status [--json] [PID]",
    "  build-tools/tools/bin/tail-log --status -w [SECONDS] [--json] [PID]",
    "  build-tools/tools/bin/l        --status -w [SECONDS] [--json] [PID]",
    "",
    "If PID is omitted:",
