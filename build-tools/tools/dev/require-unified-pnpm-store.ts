 ...
 * - Hash is derived from build-tools/tools/nix/node-modules.hashes.json so changes to lock hashes rotate the store
 ...
 *
 * Usage:
 *   node build-tools/tools/dev/require-unified-pnpm-store.ts
 *
 * Effects:
