...
export const NIXOS_SHARED_HOST_ARTIFACT_PROVENANCE_SCHEMA =
  "nixos-shared-host-artifact-provenance@1";
...
type NixosSharedHostArtifactProvenance = {
  schemaVersion: typeof NIXOS_SHARED_HOST_ARTIFACT_PROVENANCE_SCHEMA;
  artifactKind: NixosSharedHostAdmittedArtifact["kind"];
...
async function ensureArtifactProvenance(
  ...
  const provenance: NixosSharedHostArtifactProvenance = {
