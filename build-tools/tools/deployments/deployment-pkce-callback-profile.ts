...
export const PKCE_CALLBACK_ENV = {
  mode: "BNX_DEPLOYMENT_PKCE_CALLBACK_MODE",
  externalScheme: "BNX_DEPLOYMENT_PKCE_CALLBACK_EXTERNAL_SCHEME",
  externalHost: "BNX_DEPLOYMENT_PKCE_CALLBACK_HOST",
  externalPort: "BNX_DEPLOYMENT_PKCE_CALLBACK_EXTERNAL_PORT",
  externalPath: "BNX_DEPLOYMENT_PKCE_CALLBACK_EXTERNAL_PATH",
  bindHost: "BNX_DEPLOYMENT_PKCE_CALLBACK_BIND_HOST",
  bindPort: "BNX_DEPLOYMENT_PKCE_CALLBACK_BIND_PORT",
  bindPath: "BNX_DEPLOYMENT_PKCE_CALLBACK_BIND_PATH",
} as const;
