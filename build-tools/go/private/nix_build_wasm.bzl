...
go_nix_build_wasm = rule(
    ...
    attrs = with_nix_artifact_action_attrs({
        ...
        "wasm_abi": attrs.string(default = "bare"),
        "wasm_abi_explicit": attrs.bool(default = False),
        "wasm_target": attrs.string(default = "wasm32-unknown-unknown"),
        "wasm_link_kind": attrs.string(default = "module"),
        "wasm_allocator": attrs.string(default = "tinygo"),
        "wasm_libc": attrs.string(default = "none"),
        "wasm_exception_policy": attrs.string(default = "trap"),
        "wasm_runtime": attrs.string(default = "webassembly"),
