...
def _source_snapshot_runner_impl(ctx):
    ...
    module_tree = ctx.actions.symlinked_dir(
        ctx.attrs.name + ".modules",
        {
            ...
            "dev/rust-composition-evidence.ts": ctx.attrs.rust_composition_module,
...
source_snapshot_runner = rule(
    ...
    attrs = {
        ...
        "rust_composition_module": attrs.source(default = "@viberoots//build-tools/tools/dev:rust-composition-evidence.ts"),
