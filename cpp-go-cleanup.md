...
- Update developer notes in `build-system-design.md` Appendix to reference `planner/lib.nix`.
...
- Update `docs/handbook/troubleshooting.md` and `build-system-design.md` (dev overrides sections) to point to the shared helper.
