...
load("//lang:provider_edges.bzl", _providers_for = "providers_for", _realize_provider_edges = "realize_provider_edges", _target_key_for_current_package = "target_key_for_current_package")
