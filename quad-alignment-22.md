...
Update `build-system-design.md` (exporter section) to clarify observed behavior:
...
Update `build-system-design.md` (exporter section) to state the contract in concrete terms:
...
Update exporter authoring notes in `build-system-design.md` to point at the shared helper as the canonical place to implement importer-scoped attachment and validation.
